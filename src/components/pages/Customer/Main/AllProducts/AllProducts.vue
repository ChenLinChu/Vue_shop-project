<template>
  <div class="allProducts">
    ...
    <div class="productsContainer" v-for="(product, index) in productFiltered" :key="product.id">
      <div class="product">
        <!-- 特價標籤 -->
        <div
          class="saleTag"
        ...
        <!-- 最近上市標籤 -->
        <div class="newTag" v-else-if="index < 5">NEW</div>
        <!-- 產品圖片 -->
        <div
          class="productPic"
...
export default {
  ...
  methods: {
    getProducts(payload) {
      this.$store.dispatch("customerGetProductFiltered", payload);
    },
